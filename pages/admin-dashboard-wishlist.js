...
class AdminDashboardWishlist extends Component {
  constructor(props) {
    super(props);
    this.state = {
      auth: null,
                    ...
                    <div className="col-lg-6">
                      <div className="breadcrumb-content">
                        <div className="section-heading">
                          <h2 className="sec__title font-size-30">Bookmarks</h2>
                        </div>
                      </div>
                          ...
                          <div className="card-item card-item-list">
                            ...
                            <div className="card-body">
                              ...
                              <p className="card-meta pt-2 pb-3">
                                ...
                                adipisicing elit. Assumenda atque blanditiis cum
                                deserunt dolores fugit harum iusto natus
                                pariatur, perspiciatis quae quis repudiandae
...
export default withRouter(AdminDashboardWishlist);
