                ...
                <div className="col-lg-6">
                  <div className="breadcrumb-content">
                    <div className="section-heading">
                      <h2 className="sec__title">Cruise Booking</h2>
                    </div>
                    ...
                    <div className="card-item shadow-none radius-none mb-0">
                      <div className="card-img pb-4">
                        <a href="cruise-details.html" className="d-block">
                          <img src="images/bg-3.jpg" alt="cruise-img" />
                        </a>
                      </div>
                      <div className="card-body p-0">
                        <div className="d-flex justify-content-between">
                          <div>
                            <h3 className="card-title">5 Nights Cruise</h3>
                        ...
                        <ul className="list-items list-items-2 list--items-2 py-2">
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-ship mr-1 text-black font-size-17" />Departs</span>12 May 2020 7:40am</li>
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-ship mr-1 text-black font-size-17" />Returns</span>16 May 2020 8:40am</li>
                        </ul>
                        <h3 className="card-title pb-3">Order Details</h3>
                        <div className="section-block" />
                        <ul className="list-items list-items-2 py-3">
                          <li><span>Cruise:</span>Marina Cruise</li>
                          <li><span>Cabin Type:</span>Grand Suite</li>
                          <li><span>Food &amp; Dining:</span>₦5,000</li>
                          <li><span>Cruise Price:</span>₦50,000</li>
                          <li><span>Passengers:</span>4</li>
                        </ul>
                        <div className="section-block" />
                        <ul className="list-items list-items-2 pt-3">
                        <li><span>Sub Total:</span>₦55,000</li>
                          <li><span>VAT (7.5%):</span>₦500</li>
                          <li><span>Total Price:</span>₦55,500</li>
                        </ul>
                      </div>
                    </div>{/* end card-item */}
                  </div>{/* end form-content */}
...
export default withRouter(CruiseBooking);
