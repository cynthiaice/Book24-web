                ...
                <div className="col-lg-6">
                  <div className="breadcrumb-content">
                    <div className="section-heading">
                      <h2 className="sec__title">Car Booking</h2>
                    </div>
                        ...
                        <div className="contact-form-action">
                          <form method="post">
                            <div className="row">
                              ...
                              <div className="col-lg-12">
                                <div className="btn-box">
                                  <button className="theme-btn" type="button">Login Account</button>
                                </div>
                              </div>{/* end col-lg-12 */}
                            </div>
                          </form>
                    ...
                    <div className="card-item shadow-none radius-none mb-0">
                      <div className="card-img pb-4">
                        <a href="cruise-details.html" className="d-block">
                          <img src="images/bg-7.jpg" alt="cruise-img" />
                        </a>
                      </div>
                      <div className="card-body p-0">
                        <div className="d-flex justify-content-between">
                          <div>
                            <h3 className="card-title">Mercedes E Class</h3>
                            <p className="card-meta">Lagos Island, Lagos</p>
                          </div>
                          <div>
                            <a href="cruise-details.html" className="btn ml-1"><i className="la la-edit" data-toggle="tooltip" data-placement="top" title="Edit" /></a>
                          </div>
                        </div>
                        ...
                        <ul className="list-items list-items-2 list--items-2 py-2">
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-calendar mr-1 text-black font-size-17" />Date</span>12 May 2020 to 13 May 2020</li>
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-clock-o mr-1 text-black font-size-17" />Time</span>12:10 pm to 3:50 pm</li>
                        ...
                        <ul className="list-items list-items-2 py-3">
                          ...
                          <li><span>Damage Protection:</span>₦5,000</li>
                          <li><span>Price Per Day:</span>₦20,000</li>
                          <li><span>Passengers:</span>4</li>
                        </ul>
                        <div className="section-block" />
                        <ul className="list-items list-items-2 pt-3">
                        <li><span>Sub Total:</span>₦25,000</li>
                          <li><span>VAT (7.5%):</span>₦500</li>
                          <li><span>Total Price:</span>₦25,500</li>
                        </ul>
                      </div>
                    </div>{/* end card-item */}
                  </div>{/* end form-content */}
...
export default withRouter(CarBooking);
