...
class AdminDashboardTravelAgents extends Component {
  constructor(props) {
    super(props);
    this.state = {
      auth: null,
...
export default withRouter(AdminDashboardTravelAgents);
