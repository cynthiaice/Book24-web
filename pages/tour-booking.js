                ...
                <div className="col-lg-6">
                  <div className="breadcrumb-content">
                    <div className="section-heading">
                      <h2 className="sec__title">Tour Booking</h2>
                    </div>
                    ...
                    <div className="card-item shadow-none radius-none mb-0">
                      ...
                      <div className="card-body p-0">
                        <div className="d-flex justify-content-between">
                          <div>
                            <h3 className="card-title">Lagos City Tour</h3>
                            <p className="card-meta">Lekki Phase 1, Lagos</p>
                          </div>
                          <div>
                        ...
                        <ul className="list-items list-items-2 list--items-2 py-2">
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-calendar mr-1 text-black font-size-17" />Check in</span>12 May 2020 7:40am</li>
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-calendar mr-1 text-black font-size-17" />Check out</span>15 May 2020 7:40am</li>
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-clock-o mr-1 text-black font-size-17" />Duration</span>3 days 3 hours</li>
