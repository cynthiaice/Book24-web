                ...
                <div className="col-lg-6">
                  <div className="breadcrumb-content">
                    <div className="section-heading">
                      <h2 className="sec__title">Flight Booking</h2>
                    </div>
                    ...
                    <div className="card-item shadow-none radius-none mb-0">
                      <div className="card-img pb-4">
                        <a href="flight-single.html" className="d-block">
                          <img src="images/bg-6.png" alt="plane-img" />
                        </a>
                      </div>
                      <div className="card-body p-0">
                        <div className="d-flex justify-content-between">
                          <div>
                            <h3 className="card-title">Lagos to Ghana</h3>
                            <p className="card-meta">One way Flight</p>
                          </div>
                          <div>
                            <a href="flight-single.html" className="btn ml-1"><i className="la la-edit" data-toggle="tooltip" data-placement="top" title="Edit" /></a>
                          </div>
                        </div>
                        ...
                        <ul className="list-items list-items-2 list--items-2 py-2">
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-plane mr-1 font-size-17" />Take off</span>12 May 2020 7:40am</li>
                          <li className="font-size-15"><i className="la la-clock-o mr-1 text-black font-size-17" />12hrs 40 min</li>
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-plane mr-1 font-size-17" />Landing</span>13 May 2020 8:40am</li>
                        </ul>
                        <h3 className="card-title pb-3">Order Details</h3>
                        <div className="section-block" />
                        <ul className="list-items list-items-2 py-3">
                          <li><span>Airline:</span>Air Peace</li>
                          <li><span>Flight Type:</span>Economy</li>
                          <li><span>Base Fare:</span>₦54,000</li>
