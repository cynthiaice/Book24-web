                ...
                <div className="col-lg-6">
                  <div className="breadcrumb-content">
                    <div className="section-heading">
                      <h2 className="sec__title">Event Booking</h2>
                    </div>
                          ...
                          <div className="col-lg-12">
                            <div className="input-box">
                              <div className="custom-checkbox mb-0">
                                ...
                                <label htmlFor="receiveChb">I want to receive Book24's promotional offers in the future</label>
                              </div>
                            </div>
                          </div>{/* end col-lg-12 */}
                        </div>
                    ...
                    <div className="card-item shadow-none radius-none mb-0">
                      <div className="card-img pb-4">
                        <a href="tour-details.html" className="d-block">
                          <img src="images/aylive.jpg" alt="tour-img" />
                        </a>
                      </div>
                      <div className="card-body p-0">
                        <div className="d-flex justify-content-between">
                          <div>
                            <h3 className="card-title">AY Live</h3>
                            <p className="card-meta">Eko Hotel, Lagos</p>
                          </div>
                          <div>
                            <a href="tour-details.html" className="btn ml-1"><i className="la la-edit" data-toggle="tooltip" data-placement="top" title="Edit" /></a>
                          </div>
                        </div>
                        ...
                        <ul className="list-items list-items-2 list--items-2 py-2">
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-calendar mr-1 text-black font-size-17" />Start Date</span>12 May 2020 3:00pm</li>
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-calendar mr-1 text-black font-size-17" />End Date</span>13 May 2020 5:00pm</li>
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-clock-o mr-1 text-black font-size-17" />Duration</span>2 days</li>
                          <li className="font-size-15"><span className="w-auto d-block mb-n1"><i className="la la-map-marker mr-1 text-black font-size-17" />Location</span>Lekki Phase 1, Lagos</li>
                        </ul>
                        <h3 className="card-title pb-3">Order Details</h3>
                        <div className="section-block" />
                        <ul className="list-items list-items-2 py-3">
                          <li><span>Event:</span>2 Days</li>
                          <li><span>Ticket Type:</span>Regular</li>
                          <li><span>Ticket Price:</span>₦5,000</li>
                        </ul>
                        <div className="section-block" />
                        <ul className="list-items list-items-2 pt-3">
                          <li><span>Sub Total:</span>₦5,000</li>
                          <li><span>VAT (7.5%):</span>₦500</li>
                          <li><span>Total Price:</span>₦5,500</li>
                        </ul>
                      </div>
                    </div>{/* end card-item */}
                  </div>{/* end form-content */}
