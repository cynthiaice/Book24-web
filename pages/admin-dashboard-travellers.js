...
class AdminDashboardTravellers extends Component {
  constructor(props) {
    super(props);
    this.state = {
      auth: null,
                            ...
                            <table className="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div className="table-content">
                                      <h3 className="title">David Matin</h3>
                                    </div>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div className="table-content">
                                      <h3 className="title">Peter Micahel</h3>
                                    </div>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div className="table-content">
                                      <h3 className="title">Amir Sohail</h3>
                                    </div>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div className="table-content">
                                      <h3 className="title">Jack Bauer</h3>
                                    </div>
                                  </td>
...
export default withRouter(AdminDashboardTravellers);
