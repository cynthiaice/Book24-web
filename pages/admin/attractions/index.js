...
class Attractions extends Component {
  ...
  render() {
    ...
    const attraction_data = this.state.attractions.map(
      function(item, index) {
        return (
          <tr>
            <td>{index + 1}</td>
    ...
    const ModalAttraction = ({ handleClose, show, children }) => {
    ...
    return (
      ...
      <div className="main-box">
        ...
        <p className="admin-header">Attraction</p>
        <button
        ...
        <div className={showHideClassNameCreate}>
          <p className="admin-header">Add Attraction</p>
          {this.state.error_div && (
            <div className="error">{this.state.error}</div>
          )}
          <form onSubmit={this.createAttraction.bind(this)}>
            ...
            <br/><div className="input-row">
              {/* <button onClick={this.createAttraction.bind(this)}>Create</button>{" "} */}
