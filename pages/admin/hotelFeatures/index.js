...
class HotelFeatures extends Component {
  ...
  render() {
    ...
    const hotelFeature_data = this.state.hotelFeatures.map(
      function(item, index) {
        return (
          <tr>
            <td>{index + 1}</td>
    ...
    return (
      ...
      <div className="main-box">
        ...
        >
          <p>Are you sure you want to delete this hotelFeature</p>
        </ModalHotelFeature>
        <p className="admin-header">Hotel Feature</p>
        <button
        ...
        <div className={showHideClassNameCreate}>
          <p className="admin-header">Add Hotel Feature</p>
...
export default withRouter(HotelFeatures);
