...
class ActivityTypes extends Component {
  ...
  render() {
    ...
    const activityType_data = this.state.activityTypes.map(
      function(item, index) {
        return (
          <tr>
            <td>{index + 1}</td>
    ...
    const ModalActivityType = ({ handleClose, show, children }) => {
    ...
    return (
      ...
      <div className="main-box">
        ...
        >
          <p>Are you sure you want to delete this activityType</p>
        </ModalActivityType>
        <p className="admin-header">ActivityType</p>
        <button
          className="admin-button"
          onClick={this.handleShowCreate.bind(this)}
        >
          <p>ADD ACTIVITY TYPE</p>
        </button>
        <div className={showHideClassNameCreate}>
          <p className="admin-header">ADD ACTIVITY TYPE</p>
          {this.state.error_div && (
            <div className="error">{this.state.error}</div>
          )}
          <form onSubmit={this.createActivityType.bind(this)}>
            ...
            <br/><div className="input-row">
              {/* <button onClick={this.createActivityType.bind(this)}>Create</button>{" "} */}
...
export default withRouter(ActivityTypes);
