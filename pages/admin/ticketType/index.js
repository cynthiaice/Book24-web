...
class TicketTypes extends Component {
    ...
    //      router.push("/");
        ...
        for (let i = 0; i < len; i++) {
          ...
          this.setState(prevState => ({
            ticketTypes: [...prevState.ticketTypes, row]
          }));
        }
      })
      .catch(error => {
  ...
  render() {
    ...
    const ticketType_data = this.state.ticketTypes.map(
      function(item, index) {
        return (
          <tr>
            <td>{index + 1}</td>
    ...
    const ModalTicketType = ({ handleClose, show, children }) => {
    ...
    return (
      ...
      <div className="main-box">
        ...
        >
          <p>Are you sure you want to delete this ticketType</p>
        </ModalTicketType>
        ...
        <div className={showHideClassNameCreate}>
          <p className="admin-header">Add Ticket Type</p>
          {this.state.error_div && (
            <div className="error">{this.state.error}</div>
          )}
          <form onSubmit={this.createTicketType.bind(this)}>
            ...
            <div className="input-row">
              {/* <button onClick={this.createTicketType.bind(this)}>Create</button>{" "} */}
...
export default withRouter(TicketTypes);
