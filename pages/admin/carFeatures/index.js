...
class CarFeatures extends Component {
  ...
  render() {
    ...
    const carFeature_data = this.state.carFeatures.map(
      function(item, index) {
        return (
          <tr>
            <td>{index + 1}</td>
    ...
    return (
      ...
      <div className="main-box">
        ...
        >
          <p>Are you sure you want to delete this carFeature</p>
        </ModalCarFeature>
        <p className="admin-header">Car Feature</p>
        <button
        ...
        <div className={showHideClassNameCreate}>
          <p className="admin-header">Add Car Feature</p>
...
export default withRouter(CarFeatures);
