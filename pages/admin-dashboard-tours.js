...
class AdminDashboardTour extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showIndex: true,
  ...
  handleDelete = async () => {
    ...
    await axios
      .delete(API_URL + `tour/${this.props.currentHotel.id}`, config)
      .then((response) => {
        console.log(response);
        if (response.data.message == "Token is not valid") {
          //      router.push("/");
    ...
    return (
      <div>
        ...
        <div className="section-bg">
          ...
          <SubAdminSideBar tourActive="page-active" />
                    ...
                    <div className="col-lg-6">
                      <div className="breadcrumb-content">
                        <div className="section-heading">
                          <h2 className="sec__title font-size-30">Tour</h2>
                        </div>
                      </div>
...
const AdminDashboardTour__ = withRouter(AdminDashboardTour);
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(AdminDashboardTour__);
