                ...
                <div className="col-lg-12">
                  <div className="breadcrumb-content text-center">
                    <div className="section-heading">
                      <h2 className="sec__title">Room Grid</h2>
                    </div>
                  ...
                  <div className="filter-top d-flex align-items-center justify-content-between">
                    <div className="section-tab section-tab-3">
                      <ul className="nav nav-tabs" id="myTab4" role="tablist">
                        ...
                        <li className="nav-item">
                          <a className="nav-link" id="single-rooms" data-toggle="tab" href="#single-rooms" role="tab" aria-controls="single-rooms" aria-selected="false">
                            Single Rooms
                          </a>
                        </li>
                        <li className="nav-item">
                          <a className="nav-link" id="double-rooms-tab" data-toggle="tab" href="#double-rooms" role="tab" aria-controls="double-rooms" aria-selected="false">
                            Double Rooms
                          </a>
                        </li>
                        <li className="nav-item">
                    ...
                    <div className="layout-view d-flex align-items-center">
                      <a href="room-grid.html" data-toggle="tooltip" data-placement="top" title="Grid View" className="active"><i className="la la-th-large" /></a>
                      <a href="room-list.html" data-toggle="tooltip" data-placement="top" title="List View"><i className="la la-th-list" /></a>
                    </div>
                  </div>
                </div>{/* end filter-wrap */}
              </div>{/* end col-lg-12 */}
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="btn-box mt-4 text-center">
                  ...
                  <p className="font-size-13 pt-2">Showing 1 - 6 of 124 Rooms</p>
                </div>{/* end btn-box */}
              </div>{/* end col-lg-12 */}
            </div>{/* end row */}
          </div>{/* end container */}
...
export default withRouter(ActivitySearchResult);
