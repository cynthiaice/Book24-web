                ...
                <div className="col-lg-6">
                  <div className="breadcrumb-content">
                    <div className="section-heading">
                      <h2 className="sec__title">Hotel Booking</h2>
                    </div>
                    ...
                    <div className="card-item shadow-none radius-none mb-0">
                      <div className="card-img pb-4">
                        <a href="hotel-single.html" className="d-block">
                          <img src="images/four points.jpg" alt="tour-img" />
                        </a>
                      </div>
                      <div className="card-body p-0">
                        <div className="d-flex justify-content-between">
                          <div>
                            <h3 className="card-title">Four Points By Sheraton</h3>
...
export default withRouter(HotelBooking);
